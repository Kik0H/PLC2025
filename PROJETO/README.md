...
## Projeto Final da UC, realizado por:
...
python main.py ficheiro1.pas ficheiro2.pas ... **OU** python main.py *.pas

Para perceber o funcionamento do compilador, ler [RELATORIO](relatorio.pdf)
